# ESP32 - Device for C basic programming learning

## Project Overview
This is an ESP32-based device using DHT22 and BH1750 sensor.

## Tech Stack
- Platform: ESP32
- Framework: Code must be written for ESP-IDF (v5.5+)
- Language: Code must be written in pure C (C11 standard)
- Build System: CMake
- Ambient Light Sensor: BH1750 (by I2C)
- Temperature and Humidity Sensor: DHT22 (over GPIO)
